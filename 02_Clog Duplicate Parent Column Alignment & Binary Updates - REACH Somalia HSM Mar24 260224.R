...
# you need to update the FO information here!!
fo_in_charge <- "hassan"
fo_finished_clogs_path <- paste0("04_data_cleaning/", fo_in_charge," - Clogs/finished_clogs/")
...
sink(paste0("06_combining_clean_data/fo_level_corrected_clogs_inputs/output_text_support_files/", fo_in_charge, "_step_2_output.txt"))
